...
namespace winrt::DisenchantMusicPlayer::implementation
{
    ...
    void SettingsPageT<D, I...>::InitializeComponent()
    {
        if (!_contentLoaded)
        {
            _contentLoaded = true;
            ::winrt::Windows::Foundation::Uri resourceLocator{ L"ms-appx:///SettingsPage.xaml" };
            ::winrt::Microsoft::UI::Xaml::Application::LoadComponent(*this, resourceLocator, ComponentResourceLocation::Application);
        }
    }

    template <typename D, typename ... I>
    void SettingsPageT<D, I...>::Connect(int32_t connectionId, IInspectable const& target)
    {
        switch (connectionId)
        {
        case 2:
            {
                ...
                this->PickFolderButton(targetElement);
                ...
                targetElement.Click([weakThis](::winrt::Windows::Foundation::IInspectable const& p0, ::winrt::Microsoft::UI::Xaml::RoutedEventArgs const& p1){
                    ...
                    {
                        ::winrt::get_self<D>(t)->PickFolderButton_Click(p0, p1);
                    }
                });
            }
            break;
        case 3:
            {
                ...
                this->OutputTextBlock(targetElement);
            }
            break;
        }
        _contentLoaded = true;
    ...
    template <typename D, typename ... I>
    void SettingsPageT<D, I...>::DisconnectUnloadedObject(int32_t)
    {
        throw ::winrt::hresult_invalid_argument { L"No unloadable objects to disconnect." };
    }

    template <typename D, typename ... I>
    void SettingsPageT<D, I...>::UnloadObject(DependencyObject const&)
    {
    ...
    template <typename D, typename... I>
    IComponentConnector SettingsPageT<D, I...>::GetBindingConnector(int32_t, IInspectable const&)
    {
        return nullptr;
    }

    template struct SettingsPageT<struct SettingsPage>;
}
