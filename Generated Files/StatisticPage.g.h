...
namespace winrt::DisenchantMusicPlayer::implementation
{
    ...
    struct __declspec(empty_bases) StatisticPage_base : implements<D, DisenchantMusicPlayer::StatisticPage, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = StatisticPage_base;
        using class_type = DisenchantMusicPlayer::StatisticPage;
        using implements_type = typename StatisticPage_base::implements_type;
        using implements_type::implements_type;
        using composable_base = winrt::Microsoft::UI::Xaml::Controls::Page;
        hstring GetRuntimeClassName() const
        {
            return L"DisenchantMusicPlayer.StatisticPage";
        }
        StatisticPage_base()
        {
...
namespace winrt::DisenchantMusicPlayer::factory_implementation
{
    ...
    struct __declspec(empty_bases) StatisticPageT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = DisenchantMusicPlayer::StatisticPage;
...
#if defined(WINRT_FORCE_INCLUDE_STATISTICPAGE_XAML_G_H) || __has_include("StatisticPage.xaml.g.h")

#include "StatisticPage.xaml.g.h"
...
{
    template <typename D, typename... I>
    using StatisticPageT = StatisticPage_base<D, I...>;
}
