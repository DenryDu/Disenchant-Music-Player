...
namespace winrt::DisenchantMusicPlayer::implementation
{
    ...
    struct __declspec(empty_bases) SonglistPage_base : implements<D, DisenchantMusicPlayer::SonglistPage, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = SonglistPage_base;
        using class_type = DisenchantMusicPlayer::SonglistPage;
        using implements_type = typename SonglistPage_base::implements_type;
        using implements_type::implements_type;
        using composable_base = winrt::Microsoft::UI::Xaml::Controls::Page;
        hstring GetRuntimeClassName() const
        {
            return L"DisenchantMusicPlayer.SonglistPage";
        }
        SonglistPage_base()
        {
...
namespace winrt::DisenchantMusicPlayer::factory_implementation
{
    ...
    struct __declspec(empty_bases) SonglistPageT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = DisenchantMusicPlayer::SonglistPage;
...
#if defined(WINRT_FORCE_INCLUDE_SONGLISTPAGE_XAML_G_H) || __has_include("SonglistPage.xaml.g.h")

#include "SonglistPage.xaml.g.h"
...
{
    template <typename D, typename... I>
    using SonglistPageT = SonglistPage_base<D, I...>;
}
