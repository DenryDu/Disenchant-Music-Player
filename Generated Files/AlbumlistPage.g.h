...
namespace winrt::DisenchantMusicPlayer::implementation
{
    ...
    struct __declspec(empty_bases) AlbumlistPage_base : implements<D, DisenchantMusicPlayer::AlbumlistPage, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = AlbumlistPage_base;
        using class_type = DisenchantMusicPlayer::AlbumlistPage;
        using implements_type = typename AlbumlistPage_base::implements_type;
        using implements_type::implements_type;
        using composable_base = winrt::Microsoft::UI::Xaml::Controls::Page;
        hstring GetRuntimeClassName() const
        {
            return L"DisenchantMusicPlayer.AlbumlistPage";
        }
        AlbumlistPage_base()
        {
...
namespace winrt::DisenchantMusicPlayer::factory_implementation
{
    ...
    struct __declspec(empty_bases) AlbumlistPageT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = DisenchantMusicPlayer::AlbumlistPage;
...
#if defined(WINRT_FORCE_INCLUDE_ALBUMLISTPAGE_XAML_G_H) || __has_include("AlbumlistPage.xaml.g.h")

#include "AlbumlistPage.xaml.g.h"
...
{
    template <typename D, typename... I>
    using AlbumlistPageT = AlbumlistPage_base<D, I...>;
}
