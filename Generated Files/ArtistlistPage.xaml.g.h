...
namespace winrt::DisenchantMusicPlayer::implementation
{
    ...
    struct ArtistlistPageT : public ::winrt::DisenchantMusicPlayer::implementation::ArtistlistPage_base<D,
        ::winrt::Microsoft::UI::Xaml::Markup::IComponentConnector,
        I...>
    {
        using base_type = typename ArtistlistPageT::base_type;
        using base_type::base_type;
        using class_type = typename ArtistlistPageT::class_type;
    ...
    private:
        struct ArtistlistPage_obj1_Bindings;
