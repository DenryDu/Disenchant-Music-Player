...
namespace winrt::DisenchantMusicPlayer::implementation
{
    ...
    struct StatisticPageT : public ::winrt::DisenchantMusicPlayer::implementation::StatisticPage_base<D,
        ::winrt::Microsoft::UI::Xaml::Markup::IComponentConnector,
        I...>
    {
        using base_type = typename StatisticPageT::base_type;
        using base_type::base_type;
        using class_type = typename StatisticPageT::class_type;
    ...
    private:
        struct StatisticPage_obj1_Bindings;
